...
def index(request):
    ...
    site_home_banner_name = GeneralSetting.objects.get(name='home_banner_name').parameters
    site_home_banner_title = GeneralSetting.objects.get(name='home_banner_title').parameters
    site_home_banner_description = GeneralSetting.objects.get(name='home_banner_description').parameters
    ...
    context={
        ...
        'home_banner_name': site_home_banner_name,
        'home_banner_title' : site_home_banner_title,
        'home_banner_description' : site_home_banner_description,
